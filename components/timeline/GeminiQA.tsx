...
export default function GeminiQA({ timeline, events, people }: GeminiQAProps) {
    ...
    try {
      ...
      const response = await fetch('/api/chat', {
        ...
        body: JSON.stringify({
          ...
          context: {
            timeline,
            events: events.slice(0, 20), // Limit to top 20 events
            people: people.slice(0, 10), // Limit to top 10 people
          },
        }),
      });
    ...
    try {
      const response = await fetch('/api/chat', {
        ...
        body: JSON.stringify({
          ...
          context: {
            timeline,
            events: events.slice(0, 30), // Send more context for better answers
    ...
    <div className="max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Have questions about {timeline.title}? Ask our AI-powered history tutor for insights 
          based on the timeline content.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="flex space-x-3">
            <input
              ...
              placeholder="Ask a question about this timeline..."
              disabled={isLoading}
          ...
          <p className="text-xs text-gray-500 mt-3">
            Answers are generated by AI based on the timeline content and may not be perfect. 
